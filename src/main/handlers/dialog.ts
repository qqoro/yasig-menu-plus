 ...
 * 폴더 선택 다이얼로그
 */
export const selectFolderHandler = wrapIpcHandler(
  "selectFolder",
  async (
 ...
 * 파일 선택 다이얼로그
 */
export const selectFileHandler = wrapIpcHandler(
  "selectFile",
  async (
    _event: IpcMainInvokeEvent,
    _payload: unknown,
 ...
 */
export const selectProgramHandler = wrapIpcHandler(
  "selectProgram",
  async (
    _event: IpcMainInvokeEvent,
    _payload: unknown,
 ...
 * 실행 파일 선택 다이얼로그
 */
export const selectExecutableFileHandler = wrapIpcHandler(
