      ...
      <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex flex-1 flex-col overflow-hidden">
          ...
          <GameGridSection
            ...
            :is-excluded-tag="searchState.hasExcludeTag"
            :is-excluded-circle="searchState.hasExcludeCircle"
            :is-excluded-category="searchState.hasExcludeCategory"
            @click-tag="searchState.toggleTag"
            @click-circle="searchState.toggleCircle"
            @click-category="searchState.toggleCategory"
            @exclude-tag="searchState.toggleExcludeTag"
            @exclude-circle="searchState.toggleExcludeCircle"
            @exclude-category="searchState.toggleExcludeCategory"
